...
console.log('Testing universities: ');
...
console.log('Testing contactInfo: ' + contactInfo);
...
console.log('Testing unisWithUni: ');
...
console.log('Testing displayNames: ' + displayNames);
...
console.log('Testing lowCaseAnimalNames: ' + lowCaseAnimalNames);
...
console.log('Testing lowPopulationAnimals: ')
...
console.log('Testing populationTotal: ' + populationTotal);
